...
interface ModalComponentProps {
    isModalOpen: boolean;
    onRequestClose: () => void;
    selectedNATGateway: any;
}

const ModalComponent: React.FC<ModalComponentProps> = ({ isModalOpen, onRequestClose, selectedNATGateway }) => {
                ...
                {selectedNATGateway ? (
                    <>
                        <div style={{ backgroundColor: '#F5F5F5', padding: '10px', boxShadow: '0px 1px 1px rgba(0, 0, 0, 0.2)', border: '1px solid #F5F5F5' }}>
                            <h1 style={{ fontWeight: 'bold', color: 'black', fontSize: '1em' }}>Resource summary for {selectedNATGateway.name} ({selectedNATGateway.id})</h1>
                        </div>
                            ...
                            <div className="grid grid-cols-3 gap-5 text-sm ml-1">
                                <div className="text-gray-400 mt-5">
                                    ...
                                    <div className="text-black" >
                                        {selectedNATGateway.id}
                                    </div>
                                </div>
                                <div className="text-gray-400 mt-5">
                                    Region
                                    <div className="text-black">
                                        {selectedNATGateway.region || "N/A"}
                                    </div>
                                </div>
                                <div className="text-gray-400 mt-5">
                                    State
                                    <div className="text-black" >
                                        {selectedNATGateway.state}
                                    </div>
                                </div>
                                <div className="text-gray-400 mt-5">
                                    Public IP
                                    <div className="text-black" >
                                        {selectedNATGateway.publicIp}
                                    </div>
                                </div>
                                <div className="text-gray-400 mt-5">
                                    Private IP
                                    <div className="text-black" >
                                        {selectedNATGateway.privateIp}
                                    </div>
                                </div>
                                <div className="text-gray-400 mt-5">
                                    Subnet ID
                                    <div className="text-black" >
                                        {selectedNATGateway.subnetId}
                                    </div>
                                </div>
                                <div className="text-gray-400 mt-5">
                                    Project
                                    <div className="text-black" >
                                        {selectedNATGateway.project || "N/A"}
                                    </div>
                                </div>
                                {/* <div className="text-gray-400 mt-5">
                                    Additional Properties
                                    <div className="text-black" >
                                        {selectedNATGateway.additional_properties}
                                    </div>
                                </div> */}
                                <div className="text-gray-400 mt-5">
                                    Self Link
                                    <div className="text-blue-500 hover:text-blue-400" >
                                        <a target="_blank" href={selectedNATGateway.selfLink}>Click Here</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style={{ backgroundColor: '#FFFFFF', padding: '10px', boxShadow: '0px 1px 1px rgba(0, 0, 0, 0.2)', border: '1px solid #F5F5F5' }}>
                                    ...
                                    <table className="text-sm mt-3" style={{ padding: '10px', boxShadow: '0px 1px 1px rgba(0, 0, 0, 0.2)', border: '1px solid #F5F5F5', width: "100%" }}>
                                        ...
                                        <tbody>
                                            <tr className="even:bg-gray-100">
                                                ...
                                                <td className="p-2">{selectedNATGateway.publicIp || "N/A"}</td>
                                            </tr>
                                            <tr>
                                                <td style={{ color: 'rgb(245, 245, 245)' }} colSpan={2}><hr /></td>
                                            </tr>
                                            <tr className="even:bg-gray-100">
                                                ...
                                                <td className="p-2">{selectedNATGateway.privateIp || "N/A"}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>}
                            {selectedTab === 1 &&
                                <div>
                                    ...
                                    {renderLabelsTable(selectedNATGateway.labels)}
                                </div>
                            }
                        </div>
                    </>
