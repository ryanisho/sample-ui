...
const ModalComponent: React.FC<ModalComponentProps> = ({ isModalOpen, onRequestClose, selectedSecurityGroup }) => {
                ...
                {selectedSecurityGroup ? (
                    <>
                        <div style={{ backgroundColor: '#F5F5F5', padding: '10px', boxShadow: '0px 1px 1px rgba(0, 0, 0, 0.2)', border: '1px solid #F5F5F5' }}>
                            <h1 style={{ fontWeight: 'bold', color: 'black', fontSize: '1em' }}>Resource summary for {selectedSecurityGroup.name} ({selectedSecurityGroup.id})</h1>
                        </div>
                            ...
                            <div className="grid grid-cols-2 gap-5 text-sm ml-1">
                                <div className="text-gray-400 mt-5">
                                    ...
                                    <div className="text-black" >
                                        {selectedSecurityGroup.name || 'N/A'}
                                    </div>
                                </div>
                                <div className="text-gray-400 mt-5">
                                    VPC ID
                                ...
                                <div className="text-gray-400 mt-5">
                                    Region
                                    <div className="text-black">
                                        {selectedSecurityGroup.region}
                                    </div>
                                </div>
                                <div className="text-gray-400 mt-5">
                                    Provider
                                    <div className="text-black">
                                        {selectedSecurityGroup.provider}
                                    </div>
                                </div>
                                <div className="text-gray-400 mt-5">
                                    Attatched Instances
                                ...
                                <div className="text-gray-400 mt-2">
                                    ...
                                    <div className="text-blue-500 hover:text-blue-400" >
                                        <a target="_blank" href={selectedSecurityGroup.selfLink}>Click Here</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style={{ backgroundColor: '#FFFFFF', padding: '10px', boxShadow: '0px 1px 1px rgba(0, 0, 0, 0.2)', border: '1px solid #F5F5F5' }}>
                            ...
                            {selectedTab === 2 &&
                                <div>
                                    ...
                                    <table className="text-sm mt-3" style={{ padding: '10px', boxShadow: '0px 1px 1px rgba(0, 0, 0, 0.2)', border: '1px solid #F5F5F5', width: "100%" }}>
                                        ...
                                        <tbody>
                                            {selectedSecurityGroup.rules && typeof selectedSecurityGroup.rules === 'object' ? (
                                                Object.values(selectedSecurityGroup.rules).map((rule, index, array) => (
                                                    <React.Fragment key={index}>
                                                        <tr className="even:bg-gray-100">
                                                            ...
                                                            <td className="p-2">{(rule as any).array[3]}</td>
                                                        </tr>
                                                        {index !== array.length - 1 && (
                                                            <tr>
                            ...
                            {selectedTab === 1 &&
                                <div>
                                    ...
                                    {renderLabelsTable(selectedSecurityGroup.labels)}
                                </div>
                            }
                        </div>
                    </>
