                        ...
                        <div style={{ backgroundColor: '#FFFFFF', padding: '10px', boxShadow: '0px 1px 1px rgba(0, 0, 0, 0.2)', border: '1px solid #F5F5F5', borderTopColor: '#F0F0F0' }}>
                            <div className="grid grid-cols-2 gap-5 text-sm ml-1">
                                ...
                                <div className="text-gray-400 mt-5">
                                    Service
                                    <div className="text-black">
                                        <span className="block whitespace-nowrap">{selectedVpcEndpoint.service}</span>
                                    </div>
                                </div>
                                <div className="text-gray-400 mt-5">
                                    State
                                    <div className="text-black">
                                        <span className="block whitespace-nowrap">{selectedVpcEndpoint.state}</span>
                                    </div>
                                </div>
                                <div className="text-gray-400 mt-5">
                                    Type
                                    <div className="text-black">
                                        <span className="block whitespace-nowrap">{selectedVpcEndpoint.type}</span>
                                    </div>
                                </div>
                                <div className="text-gray-400 mt-5">
                                    Project
                                    <div className="text-black">
                                        <span className="block whitespace-nowrap">{selectedVpcEndpoint.project || "N/A"}</span>
                                    </div>
                                </div>
                                <div className="text-gray-400 mt-2">
                                    Self Link
                                    <div className="text-blue-500 hover:text-blue-400" >
                                        <a target="_blank" href={selectedVpcEndpoint.selfLink}>Click Here</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table className="text-sm mt-3" style={{ padding: '10px', boxShadow: '0px 1px 1px rgba(0, 0, 0, 0.2)', border: '1px solid #F5F5F5', width: "100%" }}>
                                        ...
                                        <tbody>
                                            <tr className="even:bg-gray-100">
                                                ...
                                                <td className="p-2">{selectedVpcEndpoint.ipv4 || "N/A"}</td>
                                            </tr>
                                            <tr>
                                                <td style={{ color: 'rgb(245, 245, 245)' }} colSpan={2}><hr /></td>
                                            </tr>
                                            <tr className="even:bg-gray-100">
                                                ...
                                                <td className="p-2">{selectedVpcEndpoint.ipv6 || "N/A"}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>}
